...
{
   string calen[8];
   calen[1]="‫هندسه - شیمی - آزمون-زبان";
   calen[2]="دینی - آمار و ترکیبیات - آزشیمی/مهارت ";
   calen[3]="فیزیک - ریاضی - عربی - ادبیات";
   calen[4]="ورزش - فیزیک - زبان،فارسی - ریاضی";
   calen[5]="فیزیک - ریاضی - هندسه - شیمی-زبان ";
